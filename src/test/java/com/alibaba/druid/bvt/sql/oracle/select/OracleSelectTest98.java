...
//                instanceof SQLAggregateExpr);
...

        {
            ...
            assertEquals("SELECT manager_id, last_name, hire_date, COUNT(*) OVER (PARTITION BY manager_id ORDER BY hire_date RANGE NUMTODSINTERVAL(100, 'day') PRECEDING) AS t_count\n" +
                    "FROM employees;", text);
        }
