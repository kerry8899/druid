...
public class OracleCreateIndexTest8_cluster extends OracleTest {
    ...
    public void test_0() throws Exception {
        ...
        assertEquals("CREATE INDEX idx_personnel ON CLUSTER personnel;", SQLUtils.toSQLString(stmt, JdbcConstants.ORACLE));

        assertEquals(1, visitor.getTables().size());

        assertTrue(visitor.getTables().containsKey(new TableStat.Name("personnel")));
